...
const sanitize_1 = __importDefault(require("../../global/scripts/helpers/sanitize"));
class Toggletip {
    constructor(element) {
    ...
    createToggletipElement() {
      ...
      <div class="nsw-toggletip__header">
        <div id="nsw-toggletip__header" class="sr-only">${(0, sanitize_1.default)(this.toggletipHeading)}</div>
      ...
      <div id="nsw-toggletip__content" class="nsw-toggletip__content">
        ${(0, sanitize_1.default)(this.toggletipContent)}
      </div>
    ...
    updateToggletip(toggletip, arrowElement, anchor = this.toggletipAnchor) {
        (0, dom_1.computePosition)(anchor, toggletip, {
            placement: 'top',
            middleware: [
                (0, dom_1.offset)(8),
                (0, dom_1.flip)(),
    ...
    checkToggletipClick(target) {
        if (!this.toggletipIsOpen)
            return;
        if (!this.toggletipElement.contains(target) && !target.closest(`[aria-controls="${this.toggletipId}"]`))
            this.toggleToggletip();
    }
    checkToggletipFocus() {
        if (!this.toggletipIsOpen)
